# PowerShell script to replace ALL HERMANS logo SVGs in ALL HTML files
...
foreach ($file in $htmlFiles) {
    ...
    if ($replacementsMade -gt 0) {
        ...
        Write-Host "  ✓ Replaced $replacementsMade HERMANS logo(s) in $($file.Name)" -ForegroundColor Green
    } else {
        Write-Host "  - No HERMANS logos found in $($file.Name)" -ForegroundColor Yellow
    }
}

Write-Host "All HTML files processed!" -ForegroundColor Green 